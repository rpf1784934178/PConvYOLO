...
def main():
    ...
    # 这种配色方案在论文里看起来很干净
    ax = sns.heatmap(df_plot, annot=True, fmt=".3f", cmap="YlGnBu",
    ...
    # 标题
    plt.title('所有模型性能对比热力图 (Baseline vs. 10阶段)', fontproperties=zh_font, fontsize=16, pad=25,
              fontweight='bold')
    plt.ylabel('')
