...
def main():
    ...
    ax.text(
        x_min + 5,
        (base_map + zone_bottom) / 2,
        "精度容忍区间 (Tolerance Zone)",
        color="#95A5A6",
    ...
    ax.annotate(
        "",
        xy=(our_fps, arrow_y_pos),
        xycoords="data",
        xytext=(base_fps, arrow_y_pos),
        textcoords="data",
    ...
    ax.text(
        ...
        fontweight="bold",
        ha="center",
        bbox={"boxstyle": "round,pad=0.3", "fc": "white", "ec": "#C0392B", "alpha": 0.9},
    )

    # --- E. 标题与标签 ---
    ax.set_title(
        "PConv-YOLO 与基准模型的推理效率-精度权衡对比", fontproperties=zh_font, fontsize=18, pad=20, fontweight="bold"
    )
